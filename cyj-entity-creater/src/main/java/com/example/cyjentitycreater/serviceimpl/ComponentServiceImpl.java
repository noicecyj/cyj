...
public class ComponentServiceImpl extends BaseService {
    ...
    private String[] createModelsJsx(EntityNamePO po, String entityName) {
        ...
        sb.append("      const dataFormRes = await ").append(underComponentName).append("Service.findDataFormByName(data);\r\n");
        sb.append("      const payload = {\r\n");
        sb.append("        ").append(po.getFormModelCode()).append(": dataFormRes.data,\r\n");
        sb.append("      };\r\n");
        sb.append("      dispatch.").append(underComponentName).append(".setState(payload);\r\n");
        sb.append("    },\r\n");
        sb.append("    /**\r\n");
        ...
        sb.append("     * @param {*} data\r\n");
        sb.append("     */\r\n");
        sb.append("    async findDataTableByName(data) {\r\n");
        sb.append("      const dataTableRes = await ").append(underComponentName).append("Service.findDataTableByName(data);\r\n");
        sb.append("      const payload = {\r\n");
        sb.append("        ").append(po.getTableModelCode()).append(": dataTableRes.data,\r\n");
        sb.append("      };\r\n");
        sb.append("      dispatch.").append(underComponentName).append(".setState(payload);\r\n");
        sb.append("    },\r\n");
    ...
    private String[] createServiceJsx(EntityNamePO po, String entityName) {
        ...
        sb.append("   * @return {*} \r\n");
        sb.append("   */\r\n");
        sb.append("  findDataFormByName(name) {\r\n");
        sb.append("    return request({\r\n");
        sb.append("      url: '/pageMenuApi/findDataFormByName',\r\n");
        sb.append("      method: 'post',\r\n");
        sb.append("      params: {\r\n");
        sb.append("        name,\r\n");
        sb.append("      },\r\n");
        ...
        sb.append("   * @return {*} \r\n");
        sb.append("   */\r\n");
        sb.append("  findDataTableByName(name) {\r\n");
        sb.append("    return request({\r\n");
        sb.append("      url: '/pageMenuApi/findDataTableByName',\r\n");
        sb.append("      method: 'post',\r\n");
        sb.append("      params: {\r\n");
        sb.append("        name,\r\n");
        sb.append("      },\r\n");
    ...
    private String[] createIndexJsx(EntityNamePO po, String[] relEntities) {
        ...
        sb.append("              <DataFormTemple items={ ").append(underComponentName).append("State.").append(po.getFormModelCode()).append(" }\r\n");
        ...
        sb.append("            <DataTableTemple dataSource={ ").append(underComponentName).append("State.").append(underComponentName).append("TableData }\r\n");
        ...
        sb.append("                type=\"simple\" pageSize={ 5 } total={ ").append(underComponentName).append("State.").append(underComponentName).append("Total } />\r\n");
        sb.append("            </Box>\r\n");
        sb.append("          </Loading>\r\n");
        sb.append("        </div>\r\n");
        sb.append("      </Cell>\r\n");
        if (relEntities != null) {
            for (String relEntity : relEntities) {
                ...
                sb.append("              style={ { width: '30%' } }>\r\n");
                sb.append("              <DataFormTemple items={ ").append(underRelEntity).append("State.").append(relPo.getFormModelCode()).append(" }\r\n");
                ...
                sb.append("            <DataTableTemple dataSource={ ").append(underRelEntity).append("State.").append(underRelEntity).append("TableData }\r\n");
                ...
                sb.append("                type=\"simple\" pageSize={ 5 } total={ ").append(underRelEntity).append("State.").append(underRelEntity).append("Total } />\r\n");
                sb.append("            </Box>\r\n");
                sb.append("          </Loading>\r\n");
                sb.append("        </div>\r\n");
                sb.append("      </Cell>\r\n");
